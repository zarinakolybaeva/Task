...
func main() {
	...
	flag.StringVar(&cfg.db.dsn, "db-dsn", "postgres://postgres:postgres@localhost/table?sslmode=disable", "PostgreSQL DSN")
	...
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "Taskninja <no-reply@taskninja.Zarina.com>", "SMTP sender")
